 ...
 * @property CI_Zip $zip
 * @property File_System $file_system
 */
class CI_Controller {}
 ...
 * @property TOC_Currencies $currencies
 * @property TOC_Customer $customer
 * @property TOC_Desktop_setting $desktop_setting
 * @property TOC_Email $email
